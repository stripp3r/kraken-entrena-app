...
export default function manifest(): MetadataRoute.Manifest {
  return {
    ...
    icons: [
      ...
      { src: "/icons/maskable-192-v7.png", sizes: "192x192", type: "image/png", purpose: "maskable" },
      { src: "/icons/maskable-512-v7.png", sizes: "512x512", type: "image/png", purpose: "maskable" },
    ],
  };
}
